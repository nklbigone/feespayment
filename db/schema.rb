...
ActiveRecord::Schema.define(version: 2019_12_11_225213) do
  ...
  create_table "departmets", force: :cascade do |t|
    t.string "department_name"
    t.string "depart_code"
    t.bigint "faculty_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["faculty_id"], name: "index_departmets_on_faculty_id"
  end
  ...
  add_foreign_key "departmets", "faculties"
