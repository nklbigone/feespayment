...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { facult_code: @faculty.facult_code, faculty_name: @faculty.faculty_name, user_id: @faculty.user_id } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { facult_code: @faculty.facult_code, faculty_name: @faculty.faculty_name, user_id: @faculty.user_id } }
